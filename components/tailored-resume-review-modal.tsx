...
function buildGeneratedByStepBadgeTitle(edit: TailoredResumeBlockEditRecord) {
  if (edit.generatedByStep === 4) {
    return "DEBUG_UI: This block's tailored output was replaced by Step 4 page-count compaction after a verified rendered-line reduction.";
  }

  return "DEBUG_UI: This block's tailored output was generated by Step 3 implementation. Step 4 did not replace this block.";
}
