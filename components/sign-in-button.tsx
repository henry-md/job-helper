...
export default function SignInButton() {
  ...
  return (
    <button
      type="button"
      className="public-sign-in-button group flex w-full items-center justify-center gap-2.5 rounded-[1rem] border border-white/12 bg-zinc-50 px-4 py-2.5 text-[0.96rem] font-semibold text-zinc-950 shadow-[0_18px_40px_rgba(255,255,255,0.1)] transition duration-200 hover:-translate-y-0.5 hover:bg-white sm:gap-3 sm:py-3 sm:text-sm"
