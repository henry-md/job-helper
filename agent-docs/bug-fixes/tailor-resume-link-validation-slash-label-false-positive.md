...
- Symptom: repeated Step 4 Tailor Resume implementation retries could fail on a project title like `C/C++ Ray Tracing Engine` even though the `\href` destination itself was correct.
