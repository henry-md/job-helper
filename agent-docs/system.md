...
- `/dashboard?tab=settings` exposes per-user AI prompt settings so users can inspect and edit the live system-prompt templates that drive extraction and resume-generation flows.
